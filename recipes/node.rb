...
node.default['cloudfoundry_mysql_service']['node']['base_dir'] = File.join(node['cloudfoundry_service']['base_dir'], "mysql")
node.default['cloudfoundry_mysql_service']['node']['db_logs_dir'] = File.join(node['cloudfoundry']['log_dir'], "mysql")
node.default['cloudfoundry_mysql_service']['node']['instances_dir'] = "#{node['cloudfoundry_mysql_service']['node']['base_dir']}/instances"
...
cloudfoundry_service_component "mysql_node" do
  service_name  "mysql"
  ruby_version  node['cloudfoundry_mysql_service']['node']['ruby_version']
